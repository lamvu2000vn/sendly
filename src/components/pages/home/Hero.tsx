...
export const Hero = () => (
    <div className="text-center space-y-6 flex flex-col items-center">
        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full rounded-3xl bg-linear-to-br from-primary to-accent shadow-2xl shadow-primary/30">
        ...
        <div className="space-y-2">
            <motion.h1 
                ...
                className="text-6xl font-black tracking-tighter text-foreground font-heading"
            >
